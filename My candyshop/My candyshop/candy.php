...
<body>
    ...
    <main>
        ...
        <section class="products">
            <div class="product">
                <img src="images/c1.jpeg" alt="Candy 1">
                <h2>Fox Candy</h2>
                <p>Explore many berry flavors of Fox.</p>
                <p>$5.99</p>
                <button>Add to Cart</button>
            </div>

            <div class="product">
                <img src="images/c2.webp" alt="Candy 2">
                <h2>M&M/h2>
                <p>M&M are the best candies to go to when feeling sad.</p>
                <p>$3.99</p>
                <button>Add to Cart</button>
            </div>

            <div class="product">
                <img src="images/bs3.webp" alt="Candy 3">
                <h2>lollipop</h2>
                <p>Try our inhouse lollipop</p>
                <p>$6.49</p>
                <button>Add to Cart</button>
            </div>

            <div class="product">
                <img src="images/bs4.webp" alt="Candy 4">
                <h2>Gummy snakes</h2>
                <p>Try our inhouse gummy snakes</p>
                <p>$4.75</p>
                <button>Add to Cart</button>
            </div>
        </section>
